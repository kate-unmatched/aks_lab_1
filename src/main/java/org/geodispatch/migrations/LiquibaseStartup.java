package org.geodispatch.migrations;
...
public class LiquibaseStartup {
    ...
    private static final String CHANGELOG = "liquibase/db.changelog-master.yaml";
    ...
    public void migrateOnStartup() {
        try (Connection c = dataSource.getConnection()) {
            ...
            db.setDefaultSchemaName("geodb");
            db.setLiquibaseSchemaName("geodb");
